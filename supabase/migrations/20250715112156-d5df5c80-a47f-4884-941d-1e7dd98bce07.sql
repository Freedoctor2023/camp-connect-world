-- Create admin user (you'll use these credentials)
-- Email: admin@freedoctor.world
-- Password: Admin@123!

-- Add default admin role for the admin user (insert after they sign up)
-- This will be done programmatically after authentication setup

-- Update camps table to require authentication for creation
